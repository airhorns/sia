...
export class Sia extends Buffer {
    ...
    readByteArray8(asReference = false) {
        const length = this.readUInt8();
        return this.readByteArrayN(length, asReference);
    }
    readByteArray16(asReference = false) {
        const length = this.readUInt16();
        return this.readByteArrayN(length, asReference);
    }
    readByteArray32(asReference = false) {
        const length = this.readUInt32();
        return this.readByteArrayN(length, asReference);
    }
    readByteArray64(asReference = false) {
